...
tf.app.flags.DEFINE_string(
    'train_dir', './models_all_scratch_20180131/',
...
tf.app.flags.DEFINE_string(
    'dataset_split_name', 'trainneg', 'The name of the train/test split.')

tf.app.flags.DEFINE_string(
    'dataset_split_name_pos', 'trainpos', 'The name of the train/test split.')

tf.app.flags.DEFINE_string(
    'dataset_split_name_val', 'val', 'The name of the train/test split.')

tf.app.flags.DEFINE_bool(
    'balance_pos', True, 'If the #pos and #neg are so different that needs balancing')
...
tf.app.flags.DEFINE_integer('eval_every_n_steps', 5000, 'validate after every n steps')
